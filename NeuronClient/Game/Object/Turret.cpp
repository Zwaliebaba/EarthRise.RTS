...
using TurretBaseT = ObjectWrapper<Component_Attachable<Component_BoundingBox<Component_Collidable<Component_Cullable<Component_Drawable<
  Component_Orientation<Component_Pluggable<Component_Sockets<Component_Supertyped<ObjectWrapperTail<ObjectType_Turret>>>>>>>>>>>;

AutoClassDerived(Turret, TurretBaseT, Position, target)
