...
void ComponentInterior::Add(ObjectT* self, const Object& object)
{
...
void ComponentInterior::Remove(ObjectT* self, const Object& object)
{
  if (object->container == self)
  {
...
namespace
{
  AutoClass(InteriorIterator, Object, object, size_t, index)
    InteriorIterator() {}
  };

  VoidFreeFunction(Object_AddInterior, "Add 'object' to the interior of 'interior'", Object, interior, Object, object)
  {
  ...
  FreeFunction(InteriorIterator, Object_GetInteriorObjects, "Return an iterator to the objects inside 'container'", Object, container)
  {
  ...
  FreeFunction(Object, InteriorIterator_Access, "Return the contents of 'iterator'", InteriorIterator, iterator)
  {
  ...
  VoidFreeFunction(InteriorIterator_Advance, "Advance 'iterator'", InteriorIterator, iterator) { Mutable(iterator).index++; }
  FunctionAlias(InteriorIterator_Advance, Advance);

  FreeFunction(bool, InteriorIterator_HasMore, "Return whether 'iterator' has more elements", InteriorIterator, iterator)
  {
