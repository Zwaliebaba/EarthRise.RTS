...
namespace GL_BufferBit
{
  ...
  constexpr Mask Accum = GL_ACCUM_BUFFER_BIT;
  constexpr Mask Color = GL_COLOR_BUFFER_BIT;
  constexpr Mask Depth = GL_DEPTH_BUFFER_BIT;
  constexpr Mask Stencil = GL_STENCIL_BUFFER_BIT;
}
...
namespace GL_FramebufferStatus
{
  ...
  inline const char* String(Enum e)
  {
    return e == Complete
             ...
             : e == Error
             ? "Error Checking Framebuffer Status"
             : e == IncompleteAttachment
             ? "Incomplete Attachment"
             : e == LayerTargets
             ? "Incomplete Layered Targets"
             : e == MissingAttachment
             ? "Missing Attachments"
             : e == Mutisample
...
{
  enum Enum { Renderbuffer = GL_RENDERBUFFER };
}
